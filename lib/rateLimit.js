...
const rateLimitWindowMillis = process.env.RATE_WINDOW || 60000;
const rateLimitWindowMaxRequests = process.env.MAX_REQUESTS || 5;

exports.getTokenBucket = function getTokenBucket(ip) {
...
exports.saveTokenBucket = function saveTokenBucket(ip, tokenBucket) {
  return new Promise((resolve, reject) => {
...
exports.rateLimit = async function rateLimit(req, res, next) {
    try {
